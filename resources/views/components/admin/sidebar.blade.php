    ...
    <x-ui.sidebar-header>
        <div class="flex items-center gap-2 px-2 py-1.5">
            ...
            <div class="flex flex-col gap-0.5 leading-none">
                <span class="font-semibold">{{ $contactInfo?->company_name ?? 'Blaze' }} Admin</span>
                ...
                <x-ui.sidebar-menu>
                    ...
                    <x-ui.sidebar-menu-item x-data="{ expanded: {{ $servicesActive ? 'true' : 'false' }} }">
                        <x-ui.sidebar-menu-button :active="$servicesActive" @click.prevent="expanded = !expanded">
                            ...
                            <x-lucide-chevron-down class="ml-auto transition-transform"
                                x-bind:class="{ 'rotate-180': expanded }" />
                        </x-ui.sidebar-menu-button>
                        <x-ui.sidebar-menu-sub x-show="expanded" x-collapse>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.services.index') }}" :active="request()->routeIs('admin.services.*')">All
                                    Services</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.service-categories.index') }}"
                                    :active="request()->routeIs('admin.service-categories.*')">Categories</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.service-features.index') }}"
                                    :active="request()->routeIs('admin.service-features.*')">Features</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                    ...
                    <x-ui.sidebar-menu-item x-data="{ expanded: {{ $projectsActive ? 'true' : 'false' }} }">
                        ...
                        <x-ui.sidebar-menu-sub x-show="expanded" x-collapse>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.projects.index') }}" :active="request()->routeIs('admin.projects.*')">All
                                    Projects</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.project-categories.index') }}"
                                    :active="request()->routeIs('admin.project-categories.*')">Categories</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                        </x-ui.sidebar-menu-sub>
                    </x-ui.sidebar-menu-item>
                    <x-ui.sidebar-menu-item><x-ui.sidebar-menu-button href="{{ route('admin.enquiries.index') }}"
                            :active="request()->routeIs('admin.enquiries.*')"><x-lucide-inbox /><span>Enquiries</span>@php $newEnquiries = \Blaze\AdminCore\Models\Enquiry::where('status','new')->count(); @endphp @if ($newEnquiries > 0)
                    ...
                    <x-ui.sidebar-menu-item><x-ui.sidebar-menu-button
                            ...
                            :active="request()->routeIs('admin.contact-messages.*')"><x-lucide-message-square /><span>Contact Messages</span>@php $newMsgs = \Blaze\AdminCore\Models\ContactMessage::where('status','new')->count(); @endphp
                            @if ($newMsgs > 0)
                                <x-ui.sidebar-menu-badge>{{ $newMsgs }}</x-ui.sidebar-menu-badge>
                            @endif
                        </x-ui.sidebar-menu-button></x-ui.sidebar-menu-item>
                    <x-ui.sidebar-menu-item><x-ui.sidebar-menu-button href="{{ route('admin.testimonials.index') }}"
                            :active="request()->routeIs('admin.testimonials.*')"><x-lucide-message-circle-heart /><span>Testimonials</span></x-ui.sidebar-menu-button></x-ui.sidebar-menu-item>
                    <x-ui.sidebar-menu-item><x-ui.sidebar-menu-button href="{{ route('admin.team-members.index') }}"
                            :active="request()->routeIs('admin.team-members.*')"><x-lucide-users /><span>Team
                                Members</span></x-ui.sidebar-menu-button></x-ui.sidebar-menu-item>
                    @php $galleryActive = request()->routeIs('admin.gallery-*'); @endphp
                    <x-ui.sidebar-menu-item x-data="{ expanded: {{ $galleryActive ? 'true' : 'false' }} }">
                        <x-ui.sidebar-menu-button :active="$galleryActive"
                            @click.prevent="expanded = !expanded"><x-lucide-image /><span>Gallery</span><x-lucide-chevron-down
                                class="ml-auto transition-transform"
                                x-bind:class="{ 'rotate-180': expanded }" /></x-ui.sidebar-menu-button>
                        <x-ui.sidebar-menu-sub x-show="expanded" x-collapse>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.gallery-albums.index') }}"
                                    :active="request()->routeIs('admin.gallery-albums.*')">Albums</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.gallery-items.index') }}" :active="request()->routeIs('admin.gallery-items.*')">All
                                    Images</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                        </x-ui.sidebar-menu-sub>
                    </x-ui.sidebar-menu-item>
                    @php $blogActive = request()->routeIs('admin.blogs.*') || request()->routeIs('admin.blog-categories.*'); @endphp
                    <x-ui.sidebar-menu-item x-data="{ expanded: {{ $blogActive ? 'true' : 'false' }} }">
                        ...
                        <x-ui.sidebar-menu-sub x-show="expanded" x-collapse>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.blogs.index') }}" :active="request()->routeIs('admin.blogs.*')">All
                                    Posts</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                            <x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                    href="{{ route('admin.blog-categories.index') }}"
                                    :active="request()->routeIs('admin.blog-categories.*')">Categories</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item>
                        </x-ui.sidebar-menu-sub>
                    </x-ui.sidebar-menu-item>
                    <x-ui.sidebar-menu-item><x-ui.sidebar-menu-button href="{{ route('admin.downloads.index') }}"
                            :active="request()->routeIs('admin.downloads.*')"><x-lucide-download /><span>Downloads</span></x-ui.sidebar-menu-button></x-ui.sidebar-menu-item>
                    <x-ui.sidebar-menu-item><x-ui.sidebar-menu-button href="{{ route('admin.company-info.index') }}"
