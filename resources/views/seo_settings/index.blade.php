            ...
            <x-ui.card>
                <x-ui.card-content class="space-y-4 pt-6">
                    <x-ui.field>
                        ...
                        <p class="text-xs text-muted-foreground mt-1">This title will be used if a specific page does
                            not have its own SEO title.</p>
                    </x-ui.field>
                    ...
                    <x-ui.field>
                        ...
                        @if (isset($settings['seo_default_image']) && $settings['seo_default_image'])
                            <div class="mb-2">
                                <img src="{{ Storage::url($settings['seo_default_image']) }}" alt="Default OG Image"
                                    class="h-32 rounded object-cover border" />
                            </div>
                        @endif
                        <input type="file" name="seo_default_image"
