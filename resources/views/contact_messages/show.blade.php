        ...
        <x-ui.breadcrumb>
            <x-ui.breadcrumb-list>
                <x-ui.breadcrumb-item>
                    <x-ui.breadcrumb-link href="{{ route('admin.contact-messages.index') }}">Contact Messages</x-ui.breadcrumb-link>
                </x-ui.breadcrumb-item>
            ...
            <x-ui.card>
                <x-ui.card-header class="flex flex-row items-start justify-between">
                    <div>
                        ...
                        <x-ui.card-description>
                            From <span class="text-foreground font-medium">{{ $message->name }}</span>
                ...
                <x-ui.card-content class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="bg-muted/40 rounded-lg p-4 text-sm leading-relaxed whitespace-pre-wrap">{{ $message->message }}</div>
                    </div>
                </x-ui.card-content>
            </x-ui.card>
        </div>
