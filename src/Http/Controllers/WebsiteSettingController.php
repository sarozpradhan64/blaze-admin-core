...
class WebsiteSettingController extends Controller
{
    ...
    {
        $keys = [
            'hero_title', 'hero_text', 'hero_stats', 'hero_image',
            'who_are_we_title', 'who_are_we_subtitle', 'who_are_we_text', 'who_are_we_bullets', 'who_are_we_image',
            'about_header_title', 'about_header_subtitle', 'about_header_text', 'about_header_image',
            'about_overview_subtitle', 'about_overview_title', 'about_overview_text', 'about_overview_paragraphs', 'about_overview_image_1', 'about_overview_image_2',
            'about_values_title', 'about_values_text', 'about_values_items',
            'about_team_subtitle', 'about_team_title', 'about_team_text',
            'seo_default_title', 'seo_default_description',
            'seo_default_keywords', 'seo_default_image',
        ];
    ...
    public function updateAbout(Request $request)
    {
        ...
        $strings = [
            'about_header_title', 'about_header_subtitle', 'about_header_text',
            'about_overview_subtitle', 'about_overview_title', 'about_overview_text',
