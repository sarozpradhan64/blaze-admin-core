<x-layouts.admin title="Blog Categories">
    ...
    <div class="flex justify-between items-center">
        <h2 class="text-2xl font-bold tracking-tight">Blog Categories</h2>
        <x-ui.button href="{{ route('admin.blog-categories.create') }}">
            ...
            <x-ui.table>
                <x-ui.table-header>
                    <x-ui.table-row>
                        ...
                        <x-ui.table-head>Posts</x-ui.table-head>
                ...
                <x-ui.table-body>
                    @forelse($categories as $category)
                        <x-ui.table-row>
                            ...
                            <x-ui.table-cell>{{ $category->posts_count }}</x-ui.table-cell>
                            <x-ui.table-cell>
