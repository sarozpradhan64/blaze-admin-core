            ...
            <x-ui.sidebar-group-content><x-ui.sidebar-menu>
                    @if ($configuration->enabled('services'))
                        ...
                        <x-ui.sidebar-menu-item x-data="{ expanded: {{ $servicesActive ? 'true' : 'false' }} }"><x-ui.sidebar-menu-button :active="$servicesActive"
                                @click.prevent="expanded = !expanded"><x-lucide-briefcase /><span>Services</span><x-lucide-chevron-down
                                ...
                                x-show="expanded" x-collapse><x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                        ...
                                        Services</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                        ...
                                        :active="request()->routeIs('admin.service-features.*')">Features</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item></x-ui.sidebar-menu-sub></x-ui.sidebar-menu-item>
                    @endif
                    @if ($configuration->enabled('projects'))
                        ...
                        <x-ui.sidebar-menu-item x-data="{ expanded: {{ $projectsActive ? 'true' : 'false' }} }"><x-ui.sidebar-menu-button :active="$projectsActive"
                                @click.prevent="expanded = !expanded"><x-lucide-folder-kanban /><span>Projects</span><x-lucide-chevron-down
                                    class="ml-auto transition-transform"
                                    x-bind:class="{ 'rotate-180': expanded }" /></x-ui.sidebar-menu-button><x-ui.sidebar-menu-sub
                                x-show="expanded" x-collapse><x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                        href="{{ route('admin.projects.index') }}" :active="request()->routeIs('admin.projects.*')">All
                                        Projects</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                    ...
                    @if ($configuration->enabled('enquiries'))
                        ...
                        <x-ui.sidebar-menu-item><x-ui.sidebar-menu-button href="{{ route('admin.enquiries.index') }}"
                                :active="request()->routeIs('admin.enquiries.*')"><x-lucide-inbox /><span>Enquiries</span>
                                @if ($newEnquiries > 0)
                    ...
                    @if ($configuration->enabled('contact-messages'))
                        ...
                        <x-ui.sidebar-menu-item><x-ui.sidebar-menu-button
                                ...
                                :active="request()->routeIs('admin.contact-messages.*')"><x-lucide-message-square /><span>Contact Messages</span>
                                @if ($newMsgs > 0)
                    ...
                    @if ($configuration->enabled('gallery'))
                        ...
                        <x-ui.sidebar-menu-item x-data="{ expanded: {{ $galleryActive ? 'true' : 'false' }} }"><x-ui.sidebar-menu-button :active="$galleryActive"
                                ...
                                x-show="expanded" x-collapse><x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                        ...
                                        Images</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item></x-ui.sidebar-menu-sub></x-ui.sidebar-menu-item>
                    @endif
                    @if ($configuration->enabled('blog'))
                        ...
                        <x-ui.sidebar-menu-item x-data="{ expanded: {{ $blogActive ? 'true' : 'false' }} }"><x-ui.sidebar-menu-button :active="$blogActive"
                                @click.prevent="expanded = !expanded"><x-lucide-file-text /><span>Blog</span><x-lucide-chevron-down
                                    class="ml-auto transition-transform"
                                    x-bind:class="{ 'rotate-180': expanded }" /></x-ui.sidebar-menu-button><x-ui.sidebar-menu-sub
                                x-show="expanded" x-collapse><x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
                                        href="{{ route('admin.blogs.index') }}" :active="request()->routeIs('admin.blogs.*')">All
                                        Posts</x-ui.sidebar-menu-sub-button></x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-item><x-ui.sidebar-menu-sub-button
