<x-layouts.admin title="SEO Settings">
    ...
    <div class="max-w-2xl">
        <h2 class="text-2xl font-bold tracking-tight mb-6">Default SEO Settings</h2>
            ...
            <x-ui.card>
                <x-ui.card-content class="space-y-4 pt-6">
                    <x-ui.field>
                        ...
                        <p class="text-xs text-muted-foreground mt-1">This title will be used if a specific page does not have its own SEO title.</p>
                    </x-ui.field>
                    ...
                    <x-ui.field>
                        ...
                        <p class="text-xs text-muted-foreground mt-1">Recommended length: 150-160 characters.</p>
                    </x-ui.field>
                    
                    <x-ui.field>
                        <x-ui.field-label>Default Meta Keywords</x-ui.field-label>
                        <x-ui.input name="seo_default_keywords" value="{{ old('seo_default_keywords', $settings['seo_default_keywords'] ?? '') }}" placeholder="construction, building, etc." />
                    </x-ui.field>
                    ...
                    <x-ui.field>
                        ...
                        @if(isset($settings['seo_default_image']) && $settings['seo_default_image'])
                            <div class="mb-2">
                                <img src="{{ Storage::url($settings['seo_default_image']) }}" alt="Default OG Image" class="h-32 rounded object-cover border" />
                            </div>
                        @endif
                        <input type="file" name="seo_default_image" class="block w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-primary-foreground hover:file:bg-primary/90" />
                        <p class="text-xs text-muted-foreground mt-1">Recommended size: 1200x630 pixels.</p>
                    </x-ui.field>
                </x-ui.card-content>
